...
const wipi = { name: 'Wi-Pi',
  picture: 'http://i.imgur.com/2OvnrBH.png',
  thumbnail: 'http://i.imgur.com/G22U0hh.png',
  info: 'My friends and I had been talking about this project for a couple weeks before hand, being SBCC students with complimentary majors, Computer Science and Computer Engineering. We decided to put our skills together and create a network of devices with sensors and actuators that could control any device, from home automation to monitoring patients in a field hospital. [Visit on Challengepost](http://challengepost.com/software/wipi).',
  id: '5529feaa881faebd5b3f995f',
};

const channels = { name: 'Channels',
  picture: 'http://i.imgur.com/MASBXgI.png',
  thumbnail: 'http://i.imgur.com/5vqfqiJ.png',
  info: 'My team and I were featured on The Channels Newspaper.  [Visit Here](http://www.thechannels.org/features/2014/02/07/sbcc-computer-science-team-hacks-its-way-to-top-prizes/)',
  id: '5529feaa881faebd5b3f9960',
};

const cloudNes = { name: 'CloudNES',
  picture: 'http://i.imgur.com/9TZaVc9.jpg',
  thumbnail: 'http://i.imgur.com/hzNoIEa.png',
  info: 'The Cloud NES was created in 36 hours at the LaHacks Hackathon. It constutites two apps, firstly there is the web app that at its frontend has an NES emulator and game cartridge selector, while on the backend we have a server that bridges this with the second app, an iOS app in the form of a digital NES controller. This way the user feels like playing an NES game completely digitally.\n\n ![webapp NES](http://i.imgur.com/0IlsxAZ.jpg)',
  id: '5529feaa881faebd5b3f9961',
};

const wannahang = { name: 'WannaHang',
  picture: 'http://i.imgur.com/HuXGljm.jpg',
  thumbnail: 'http://i.imgur.com/pwvTNYF.png',
...
const langSwitch = { name: 'LangSwitch',
  picture: 'http://i.imgur.com/Y7DFLGn.png',
  thumbnail: 'http://i.imgur.com/CMHXdY7.png',
  info: 'A sleek, simple, lightweight language switching plugin. Using the power of jQuery and HTML5 to switch languages at the click of a button.',
  id: '5529feaa881faebd5b3f9965',
};

const jarvis = { name: 'Jarvis App',
  picture: 'http://i.imgur.com/ZRHe4N8.png',
  thumbnail: 'http://i.imgur.com/Yuxyahq.png',
...
const cirqus = { name: 'Cirqus.xyz',
  picture: 'http://i.imgur.com/jDYo8Nk.png',
  thumbnail: 'http://i.imgur.com/EpU3PAq.png',
